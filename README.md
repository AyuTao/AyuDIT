...
[![CI](https://github.com/Tky9090/AyuDIT/actions/workflows/ci.yml/badge.svg)](https://github.com/Tky9090/AyuDIT/actions/workflows/ci.yml)
...
```bash
# 克隆仓库（请替换 <github-username>）
git clone https://github.com/<github-username>/AyuDIT.git
cd AyuDIT
...
- Issues: https://github.com/<github-username>/AyuDIT/issues
